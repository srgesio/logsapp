...
export function StatusLogSelector({ log }: StatusLogSelectorProps) {
    ...
    return (
        <>
            {showUpdateLogStatus.show && showUpdateLogStatus.id === log?.id && <div className="absolute top-8 mt-2 w-full min-w-40 z-10 p-4 rounded-2xl flex flex-col bg-zinc-800 justify-between gap-4">
